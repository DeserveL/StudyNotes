...
* **bin**：mvn运行的脚本，还包含（m2.conf）classworlds的配置文件
* **boot**: plexus-classworlds类加载器框架
* **conf**：配置文件，setting.xml（全局定制Maven行为）
* **lib**： java类库

##设置HTTP代理##
Maven中央仓库 _repol.maven.org_ 
```xml
<settings>
    ...
   <proxies>    
...
<project xmlns="http://maven.apache.org/POM/4.0.0"  
  ...
  <!– The Basics –>  
  <groupId>com.liuchong.boke</groupId>  
...
* **version**：当前版本
* **packaging**：打包方式（jar，war...）默认jar
* **dependencies**：包含一个或者多个**dependency**元素